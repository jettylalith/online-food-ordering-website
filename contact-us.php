                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Phone :+91 9121677699</p>
                                                <p itemprop="description">Phone :+91 9849777561</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">INDIA</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">jettylalith@gmail.com</p>
                                                <p itemprop="description">pavandurgarao@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
